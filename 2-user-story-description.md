...
| Заметки/ предположения/ ограничения | Данная пользовательская история включает в себя аутентификацию и авторизацию пользователя по уникальной паре Логин/Пароль.
Ограничения: Время ответа не может быть более 2 сек. Аутентификация и авторизация пользователя осуществляется по паре логин/пароль |
